...
namespace KamilaClient
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                case StorageEnum.SmartphoneList:
                    services.AddSingleton<IStorage<Smartphone>, SmartphoneList>();
                    break;
                case StorageEnum.FileStorage:
                    services.AddSingleton<IStorage<Smartphone>>(
