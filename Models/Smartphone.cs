...
namespace KamilaClient.Models
{
    public class Smartphone
    {
        ...
        public BaseModelValidationResult Validate()
        {
            ...
            if (!(0 < Memory && Memory < 1000)) validationResult.Append($"GroupIndex {Memory} is out of range (0..1000)");
        ...
        {
            return $"{Firm} {Model} from {Memory}-{Price}";
        }
    }
}
